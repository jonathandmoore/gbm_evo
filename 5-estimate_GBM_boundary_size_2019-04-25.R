...
no_samples = 0
  ...
  # replace NAs with 0s, so that tey don't proliferate when we start comaring columns
...
library(ggplot2)
pdf(paste0(project_id,"_dist_to_nearest_X_all_X_sites_in_GBM_genes_bp.pdf"))
...
pdf(paste0(project_id,"_sites_to_nearest_X_all_X_sites_in_GBM_genes_sites.pdf"))
