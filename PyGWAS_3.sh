...
#results_dir=${base_dir}/pygwas/results/env_gwas
results_dir=${base_dir}/pygwas/results/env_gwas_gbm
...
pheno_file=200_environments_for_pyGWAS.csv
...
#do
  ...
  srun pygwas run -t none -a amm -g ${ref_dir}/1001_SNP_MATRIX/881 -k ${pheno_dir}/gbm_881_acc_k_matrix.hdf5 -o ${gene}_results_amm.csv ${gene}.csv
